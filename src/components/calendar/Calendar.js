...
export class Calendar extends Component {
    ...
    renderInputElement() {
        if (!this.props.inline) {
            return (
                <InputText ref={this.inputRef} id={this.props.inputId} name={this.props.name} type="text" className={this.props.inputClassName} style={this.props.inputStyle} tabIndex={this.props.tabIndex}
